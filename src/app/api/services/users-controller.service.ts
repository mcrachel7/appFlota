...
export class UsersControllerService extends BaseService {
   ...
   */
  static readonly UsersControllerSignUpPath = '/signup';
  ...
  signUp$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UsersControllerService.UsersControllerSignUpPath, 'post');
    if (params) {
   ...
   */
  static readonly UsersControllerLoginPath = '/users/login';
...
'token'?: string;
    ...
    const rb = new RequestBuilder(this.rootUrl, UsersControllerService.UsersControllerLoginPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
...
'token'?: string;
  ...
  /**
   * Path part for operation usersControllerWhoAmI
   */
  static readonly UsersControllerWhoAmIPath = '/whoAmI';
  ...
  whoAmI$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UsersControllerService.UsersControllerWhoAmIPath, 'get');
    if (params) {
    }
